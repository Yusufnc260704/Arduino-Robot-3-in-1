<div style="text-align: center; font-family: Arial, sans-serif;">
  ...
  <!-- Judul Project -->
  <h1 style="color: #333;">Arduino 3 in 1</h1>

  <!-- Deskripsi Singkat -->
  <p style="max-width: 700px; margin: 0 auto; color: #555; font-size: 16px; line-height: 1.6;">
    Robot arduino 3 in 1 adalah robot yang multiperan seperti
    <b>
    1. RC Car 
    2. Following Object
    3. Avoider
